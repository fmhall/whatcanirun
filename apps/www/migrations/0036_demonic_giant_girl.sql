...
ALTER TABLE "models_info" ADD COLUMN "family_id" text;--> statement-breakpoint
ALTER TABLE "organizations" ADD COLUMN "slug" text NOT NULL;--> statement-breakpoint
ALTER TABLE "model_families" ADD CONSTRAINT "model_families_org_id_organizations_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "model_families_org_slug_idx" ON "model_families" USING btree ("org_id","slug");--> statement-breakpoint
CREATE INDEX "model_families_org_id_idx" ON "model_families" USING btree ("org_id");--> statement-breakpoint
ALTER TABLE "models_info" ADD CONSTRAINT "models_info_family_id_model_families_id_fk" FOREIGN KEY ("family_id") REFERENCES "public"."model_families"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "models_info_family_id_idx" ON "models_info" USING btree ("family_id");--> statement-breakpoint
